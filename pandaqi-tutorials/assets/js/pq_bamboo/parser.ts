...
const Parser = class 
{
    ...
    returnerDefault = (results:any) => { return results; }
    choice = (parsers:Function[], returner:Function = this.returnerDefault) => {
    ...
    reducerDefault = (results:any[]) => { return results.join(''); }
    seq = (parsers:Function[], reducer:Function = this.reducerDefault) => { 
        let input = parsers.slice();
    ...
    someReduceDefault = (results:any[]) => { return results.join(''); }
    some = (parser:Function, reducer:Function = this.someReduceDefault) => { 
        return (str:string) => {
    ...
    maybe = (parser:Function, choiceReducer:Function = undefined, someReducer:Function = undefined) => {
        return this.choice([
    ...
    nothing = (str:string) => { return ['', str]; }
    all = (str:string) => { return [str, '']; }
    fail = (_str) => { return []; }
    ...
    reqSpace = (str:string) => { // required space, unless it's the end of the line (str is empty)
    ...
    paramList = (asValue = false) => {
        return (text:string) => {
            let dataType : Function = this.functionParameter;
    ...
    termOperator = (op:string, needsSpace:boolean) => {
        return this.seq(
    ...
    exprOperator = (op:string, needsSpace:boolean) => {
        return this.seq(
    ...
    condOneOperator = (op:string, needsSpace:boolean) => {
    ...
    condTwoOperator = (kw:string, op:string, needsSpace:boolean) => {
    ...
    ifReducer = ([k,cond]) => { return new IfStatement(k, cond); }
