...
import Feedback from "js/pq_bamboo/helpers/feedback"
...
export default class Block 
{
    ...
    memory: Record<string,any>; // @TODO: It's a bit iffy with the memory and the memory context stuff, because half the time I just use a raw dictionary for some reason :/
    parentMemory: MemoryContext
    header: Header // @TODO: similarly, I'm unsure about the exact structure of Header now and how it's used, should need clearer types
    parent: Block
    feedback: Feedback[]
    ...
    toResult(onlyBody = false)
    {
        ...
        let allResults = header.bag ?? new Bag("unnamed");
    ...
    addFeedback(extraFeedback:Feedback[])
    {
    ...
    containsKeyword(value:any, type = "stop")
    {
